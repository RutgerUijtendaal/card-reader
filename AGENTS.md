...
- Card pool, role, and faction work has eleven approved, dependency-ordered implementation checkpoints. Execute them in order and keep each step independently reviewable and verified:
