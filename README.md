...
- Player-card gallery data and direct card assets are public; Evil and Neutral data and direct
  assets require staff access. Pool-partitioned TTS sheet images are public derived artifacts.
