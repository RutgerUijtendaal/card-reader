...
6. [Card classification Step 2.3: Faction classification](card-classification-step-2-3-faction-classification.md) adds Order/Blood/Dark/Metal as a second multi-valued facet, completes the role vocabulary, generalizes import classification mechanics, and scopes natural card identity by pool plus exact faction set.
