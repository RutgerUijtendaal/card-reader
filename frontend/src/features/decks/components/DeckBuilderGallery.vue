...
import { createLoadingShimItems, type GalleryDisplayItem } from '@/domain/cards/utils/galleryDisplayItems';
...
import { blurAfterFinePointerActivation } from '@/shared/utils/pointerFocus';
