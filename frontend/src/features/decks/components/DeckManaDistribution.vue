...
import {
  ...
  type ManaTypeGroup,
} from '@/domain/decks/utils/manaDistribution';
import { useManaTypeGroups } from '@/domain/decks/composables/useManaTypeGroups';
import DeckManaStatisticsSection from '@/features/decks/components/DeckManaStatisticsSection.vue';
