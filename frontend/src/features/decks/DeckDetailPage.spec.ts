...
vi.mock('@/domain/cards/components/CardGalleryItem.vue', () => ({
  default: defineComponent({
    props: {
...
vi.mock('@/domain/cards/components/CardSortMenu.vue', () => ({
  default: defineComponent({
    setup() {
...
vi.mock('@/domain/cards/components/GalleryOptionsMenu.vue', () => ({
  default: defineComponent({
    props: {
...
vi.mock('@/features/decks/components/DeckManaCurve.vue', () => ({
  default: defineComponent({
    setup(_props, { slots }) {
...
vi.mock('@/features/decks/components/DeckManaDistribution.vue', () => ({
  default: defineComponent({
    props: {
...
vi.mock('@/features/decks/components/DeckCardCountBadge.vue', () => ({
  default: defineComponent({
    props: {
