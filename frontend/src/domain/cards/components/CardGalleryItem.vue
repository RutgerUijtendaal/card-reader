...
import type { GalleryDisplayItem } from '@/domain/cards/utils/galleryDisplayItems';
...
import { buildCardDetailLocation, buildGalleryItemLocation } from '@/domain/cards/utils/gallery/galleryNavigation';
import { DEFAULT_HOVER_MODE, type HoverMode } from '@/domain/cards/utils/gallery/hoverMode';
...
import type { CardGroupGalleryItem, CardListItem, GalleryItem } from '@/domain/cards/types';
