...
import { DEFAULT_HOVER_MODE } from '@/domain/cards/utils/gallery/hoverMode';
import { DEFAULT_HOVER_PREVIEW_SCALE } from '@/domain/cards/utils/gallery/hoverPreviewScale';
import { GALLERY_OPTIONS_STORAGE_KEY } from '@/domain/cards/composables/useGalleryOptions';
import {
