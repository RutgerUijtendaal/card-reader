...
import CatalogDetailSection from '@/modules/admin/components/CatalogDetailSection.vue';
import CatalogEntriesSection from '@/modules/admin/components/CatalogEntriesSection.vue';
import CatalogKindSidebar from '@/modules/admin/components/CatalogKindSidebar.vue';
...
import {
  ...
  useCatalogAdmin,
} from '@/modules/admin/composables/useCatalogAdmin';
