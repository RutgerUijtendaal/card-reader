...
vi.mock('@/modules/admin/views/MaintenanceAdminView.vue', () => ({
  default: { template: '<div data-testid="MaintenanceAdminView" />' },
}));
vi.mock('@/modules/admin/views/CatalogAdminView.vue', () => ({
  default: { template: '<div data-testid="CatalogAdminView" />' },
}));
vi.mock('@/modules/admin/views/CardGroupsAdminView.vue', () => ({
  default: { template: '<div data-testid="CardGroupsAdminView" />' },
}));
vi.mock('@/modules/admin/views/CardBacksAdminView.vue', () => ({
  default: { template: '<div data-testid="CardBacksAdminView" />' },
}));
vi.mock('@/modules/admin/views/CardMergesAdminView.vue', () => ({
  default: { template: '<div data-testid="CardMergesAdminView" />' },
}));
vi.mock('@/modules/admin/views/ContentVersionsAdminView.vue', () => ({
  default: { template: '<div data-testid="ContentVersionsAdminView" />' },
}));
vi.mock('@/modules/admin/views/TemplatesAdminView.vue', () => ({
  default: { template: '<div data-testid="TemplatesAdminView" />' },
}));
vi.mock('@/modules/admin/views/UsersAdminView.vue', () => ({
