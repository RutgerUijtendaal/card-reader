...
def card_filter_query_data(request: Request, *, include_list_controls: bool = False) -> dict[str, object]:
    data: dict[str, object] = {
        ...
        "mana_family_keys": request.query_params.getlist("mana_family_keys"),
        "mana_family_exclude_keys": request.query_params.getlist("mana_family_exclude_keys"),
        "mana_family_match": request.query_params.get("mana_family_match"),
