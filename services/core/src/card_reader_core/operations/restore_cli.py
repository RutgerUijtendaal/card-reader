...
def main() -> None:
    ...
    parser.add_argument(
        "--backup-root",
        help=(
            "Destination directory for the automatic pre-restore safety backup. "
    ...
    backup_root = Path(args.backup_root) if args.backup_root else archive_path.resolve().parent
